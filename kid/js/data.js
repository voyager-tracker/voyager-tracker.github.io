...
// The kids edition has no data/ of its own — it reads the same NASA-sourced
// JSON as the main site (see data-repo-root on <html>, one level further up
// than data-site-root), so there is exactly one copy to keep accurate and
// in sync, not two.
const DATA_ROOT = document.documentElement.getAttribute('data-repo-root') || SITE_ROOT;
